...
public:
    ...
    void drawCircle(float centerX, float centerY, float radius, bool isFilled = (bool)true, int lineSegments = 36);
    void drawRectangle(float x, float y, float width, float height, bool isFilled = (bool)true);
